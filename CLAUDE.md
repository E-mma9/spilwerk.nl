...
- Emmanuel Tekle (20) — 3e jaar HBO ICT (Cloud & Cybersecurity, Saxion). Werkt als Systems Administrator bij Livio (zorginstelling Enschede), gepromoveerd vanuit 1st-line helpdesk (april 2025 → mei 2026 helpdesk, mei 2026 → heden sysadmin). Focus: Entra ID, Active Directory, Windows/Linux-beheer in NEN 7510/GDPR-omgeving. Homelab: 3-node Proxmox, Terraform, Ansible, Wazuh, Prometheus/Grafana. Eren Kongul is uit het bedrijf — Spilwerk is nu solo onder Emmanuel. Eerlijk over student-status op site — geen schande, juist credibility-boost.
